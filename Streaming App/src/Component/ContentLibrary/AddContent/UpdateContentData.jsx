  ...
  return (
    <div className="p-4 sm:p-6 bg-gray-50 min-h-screen mt-0">
      ...
      <div className="flex items-center mb-2 flex-wrap gap-2">
        ...
        <h1 className="text-xl sm:text-2xl font-bold ">Edit content</h1>
      </div>
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="w-full lg:w-2/5 space-y-8">
            ...
            <div className="space-y-2">
              ...
              <div
                className="border-2 border-dashed border-gray-300 rounded p-6 flex flex-col items-center justify-center cursor-pointer bg-blue-100"
                onClick={() => {
              ...
              >
                {uploadedFiles.poster[posterTab] ? (
                  uploadedFiles.poster[posterTab].name
                ) : (
                  <>
                    <AiOutlineUpload className="w-8 h-8 mb-2" />
                    Add File
                  </>
                )}
              </div>
            ...
            <>
              <div className="flex flex-col md:flex-row gap-6">
                ...
                <div className="flex-1 flex flex-col items-center">
                  <p className="font-semibold">Primary Media</p>
                  <div
                    className="border-2 border-dashed border-gray-300 rounded p-12 flex flex-col items-center justify-center cursor-pointer mt-2 bg-blue-100 w-full max-w-xs"
                    onClick={() => {
                      setUploadFor("primaryMedia");
                      setUploadCategory("Media");
                      setShowUploadModal(true);
                    }}
                  >
                    {uploadedFiles.primaryMedia ? (
                      uploadedFiles.primaryMedia.name
                    ) : (
                      <>
                        <AiOutlinePlus className="w-6 h-6 mb-2" />
                        Add Media
                      </>
                    )}
                  </div>
                ...
                {/* Preview Media */}
                <div className="flex-1 flex flex-col items-center">
                  <p className="font-semibold">Preview Media</p>
                  <div
                    className="border-2 border-dashed border-gray-300 rounded p-12 flex flex-col items-center justify-center cursor-pointer mt-2 bg-blue-100 w-full max-w-xs"
                    onClick={() => {
                      setUploadFor("previewMedia");
                      setUploadCategory("Preview Media");
                      setShowUploadModal(true);
                    }}
                  >
                    {uploadedFiles.previewMedia ? (
                      uploadedFiles.previewMedia.name
                    ) : (
                      <>
                        <AiOutlinePlus className="w-6 h-6 mb-2" />
                        Add Media
              ...
              <div className="flex flex-col gap-6">
                {["website", "mobile", "tv"].map((type) => (
                  <div key={type} className="w-full md:w-2/3">
                    ...
                    <div
                      className="border-2 border-dashed border-gray-300 rounded p-6 flex flex-col items-center justify-center cursor-pointer bg-blue-100 w-full h-32"
                      onClick={() => {
                    ...
                    >
                      {uploadedFiles.banner[type] ? (
                        uploadedFiles.banner[type].name
                      ) : (
                        <>
                          <AiOutlinePlus className="w-6 h-6 mb-1" />
                          Add File
                        </>
                      )}
                    </div>
      ...
      <FileUploadModal
        ...
        onUpload={(file) => {
          ...
          } else if (uploadFor.startsWith("addons")) {
            setUploadedFiles((prev) => ({
              ...prev,
              addons: [...prev.addons, file],
            }));
          }
